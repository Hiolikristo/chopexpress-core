...
class NotificationEngine:
    ...
    def send_order_created(self, order: Dict[str, Any], customer_email: str):
    ...
    def send_driver_offer(self, order: Dict[str, Any], driver: Dict[str, Any]):
    ...
    def send_merchant_order(self, order: Dict[str, Any], merchant_email: str):
    ...
    def send_order_completed(self, order: Dict[str, Any], customer_email: str):
